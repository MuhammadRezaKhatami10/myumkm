...
<head>
  ...
  <title>K4-Proyek1 | Pengguna</title>
...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="col-md-12 col-sm-6 col-xs-12">
              <p><h1 class="text-center"><strong><?php echo $c['pengguna_nama'];?></strong></h1></p>
            ...
            <div class="col-md-12 d-xs-none"><br><br><hr></div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright @K4-Proyek1</a>.</strong> All rights reserved.
  </footer>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $pengguna_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo site_url().'/admin/pengguna/hapus_pengguna'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							<input type="hidden" name="kode" value="<?php echo $pengguna_id;?>"/> 
